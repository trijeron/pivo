...
const translations = {
  cs: {
    ...
    admin: {
      ...
      pubAddressPlaceholder: 'Adresa hospody',
      addPubButton: '+ Přidat hospodu',
      editActivePub: 'Upravit aktivní hospodu',
      ...
      catalogAlreadyInPub: 'už je v aktivní hospodě',
      catalogSelectAll: 'Vybrat vše',
      catalogClear: 'Zrušit výběr',
      catalogQuickAdd: '+ Přidat vybraná ({count})',
      ...
      importFormat: 'Formát:',
      importFormatValue: 'Rada, vyfotte co mají a nahrajte do AI s poznámmkou chi JSON pole piv nebo objekt s polem beers ve tvaru \'Např:\\n[\\n  { "name": "Pilsner Urquell", "style": "Světlý ležák (12°)", "price": 65, "vol": 0.5, "abv": 4.4 }\\n]\',',
      ...
      importCancel: 'Zrušit',
      copyImportFormat: '📋 Kopírovat text',
      copyImportFormatDone: '✓ Zkopírováno!',
    ...
    people: {
      ...
      firstBeerStartTitle: 'Začátek prvního piva',
      firstBeerStartLabel: 'Výchozí čas prvního piva:',
      soberIn: 'Čistý za ~{hours} h',
      hasWhat: '📋 Co má {name}',
      alcoholCountList: '🍺 Alkohol pro promile — {name}',
      alcoholCountNote: 'Počítají se jen nápoje nad 0,5 % alkoholu vypité za posledních 24 hodin.',
      alcoholCountEmpty: 'Nic se teď do promile nepočítá.',
  ...
  en: {
    ...
    admin: {
      ...
      pubAddressPlaceholder: 'Pub address',
      addPubButton: '+ Add pub',
      editActivePub: 'Edit active pub',
      ...
      catalogAlreadyInPub: 'already in active pub',
      catalogSelectAll: 'Select all',
      catalogClear: 'Clear selection',
      catalogQuickAdd: '+ Add selected ({count})',
      ...
      importFormat: 'Format:',
      importFormatValue: 'JSON beer array or object with beers array',
      importPlaceholder: 'Example:\n[\n  { "name": "Pilsner Urquell", "style": "Lager", "price": 65, "vol": 0.5, "abv": 4.4 }\n]',
      importStyleListLabel: 'Available beer style categories:',
      importButton: 'Import',
      ...
      importCancel: 'Cancel',
      copyImportFormat: '📋 Copy text',
      copyImportFormatDone: '✓ Copied!',
    ...
    people: {
      ...
      firstBeerStartTitle: 'First beer start',
      firstBeerStartLabel: 'Default first-beer time:',
      soberIn: 'Sober in ~{hours} h',
      hasWhat: '📋 {name} has',
      alcoholCountList: '🍺 Alcohol count list — {name}',
      alcoholCountNote: 'Only drinks above 0.5% alcohol consumed during the last 24 hours are counted.',
      alcoholCountEmpty: 'Nothing currently counts toward BAC.',
  ...
  de: {
    ...
    admin: {
      ...
      pubAddressPlaceholder: 'Adresse der Kneipe',
      addPubButton: '+ Kneipe hinzufügen',
      editActivePub: 'Aktive Kneipe bearbeiten',
      ...
      catalogAlreadyInPub: 'bereits in aktiver Kneipe',
      catalogSelectAll: 'Alle auswählen',
      catalogClear: 'Auswahl löschen',
      catalogQuickAdd: '+ Ausgewählte hinzufügen ({count})',
      ...
      importFormat: 'Format:',
      importFormatValue: 'JSON-Bierliste oder Objekt mit beers-Liste',
      importPlaceholder: 'Beispiel:\n[\n  { "name": "Pilsner Urquell", "style": "Lager", "price": 65, "vol": 0.5, "abv": 4.4 }\n]',
      importStyleListLabel: 'Verfügbare Bierstil-Kategorien:',
      ...
      copyImportFormat: '📋 Text kopieren',
      copyImportFormatDone: '✓ Kopiert!',
    ...
    people: {
      ...
      firstBeerStartTitle: 'Start des ersten Biers',
      firstBeerStartLabel: 'Standardzeit für das erste Bier:',
      soberIn: 'Nüchtern in ~{hours} Std.',
      hasWhat: '📋 {name} hat',
      alcoholCountList: '🍺 Alkoholzählung — {name}',
      alcoholCountNote: 'Es zählen nur Getränke mit mehr als 0,5 % Alkohol aus den letzten 24 Stunden.',
      alcoholCountEmpty: 'Aktuell zählt nichts zum Promillewert.',
